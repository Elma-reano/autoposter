...
global ACCESS_TOKEN, MEDIA_FOLDER_PREFIX
...
@cache_handler()
async def upload_to_cloudinary(img_paths: list, folder: str | None = None) -> list[tuple[str, str]]:
...
async def main():
    ...
    cloudinary_images: list[tuple[str, str]] = await upload_to_cloudinary(absolute_paths)
